...
import css from "./stytel.module.css";
...
class ContactData extends React.Component {
    ...
    componentDidUpdate() {
        if (
            this.props.newOrderStatus.finished && !this.props.newOrderStatus.error
        ) {
                ...
                {this.props.newOrderStatus.saving ? (<Spinner/>) : (
                    <div>
                        <input 
                            ...
                            type="text" 
                            name="name" placeholder="Таны нэр"/>
                        <input 
                            onChange={this.changeStreet} type="text" name="street" placeholder="Таны гэрийн хаяг"/>
                        <input 
                        ...
                        <Button 
                            text="ИЛГЭЭХ" btnType="Success" clicked={this.saveOrder}/>
            </div>)}
        </div>);
    }
}
